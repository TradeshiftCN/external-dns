...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("provider", "The DNS provider where the DNS records will be created (required, options: ali, aws, google, azure, cloudflare, digitalocean, dnsimple, infoblox, inmemory)").Required().PlaceHolder("provider").EnumVar(&cfg.Provider, "ali", "aws", "google", "azure", "cloudflare", "digitalocean", "dnsimple", "infoblox", "inmemory")
